...
<html lang="en">
  ...
  <div class="container">
    <h1 class="display-4 text-center">Area Riservata - Login</h1>

    <form action="login.php" method="post">
     <div class="form-group">

       <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Inserisci il tuo username" name="CodiceFiscale">
     ...
     <button type="submit" class="btn btn-info" name="login">Accedi</button>
   </form>
